...
import 'package:flutter_work/Search/search_job.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNaigationbarApp(indexNum:0),
        ...
        body:StreamBuilder<QuerySnapshot<Map<String , dynamic>>>(
          ...
          builder: (context ,AsyncSnapshot snapshot){
            if(snapshot.connectionState == ConnectionState.waiting){
              ...
              print('Job Category Filter: $jobCategoryFilter');
              if(snapshot.data!.docs.isNotEmpty == true){
                print('Number of document: ${snapshot.data!.docs.length}');
                snapshot.data!.docs.forEach((doc) {
                  print('Job Category in document: ${doc['jobCategory']}');
                });
