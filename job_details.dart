...
import 'package:flutter_work/Widgets/comments_widget.dart';
...
class JobDetailScreen extends StatefulWidget {
  ...
  const JobDetailScreen({super.key, required this.uploadedBy,required this.jobID});
 ...
 Widget dividerWidget(){
  ...
  applyForJob(){
    final Uri params = Uri(
      scheme: 'mailto',
      path: emailCompany,
      query: 'subject= Applying for $jobTitle &body :Hello,please attach CV Resume file',
    );
                                        ...
                                        child: MaterialButton(
                                          onPressed: () async{
                                            if(_commentController.text.length<7){
                                              GlobalMethod.showErrorDialog(
                                                  error:'Comment can not be lass than 7 Characters' ,
                                                  ctx: context,
                                              );
                                            }
                                            else{
                                              ...
                                              await Fluttertoast.showToast(
                                                msg:'You Comment has been added',
