...
import 'package:flutter_work/Jobs/upload_job.dart';
import 'package:flutter_work/Search/profile_company.dart';
import 'package:flutter_work/Search/search_companies.dart';
import 'package:flutter_work/user_state.dart';
class BottomNaigationbarApp extends StatelessWidget {

  int indexNum =0 ;
  BottomNaigationbarApp({required this.indexNum});
    ...
    return CurvedNavigationBar(
      ...
      onTap:(index){
        if(index==0){
          ...
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_)=>AllWorker()));
